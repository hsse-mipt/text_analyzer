...
def score(y_true, y_pred, averaging, get_score):
...
def f1_score(y_true, y_pred, averaging="micro"):
    return score(y_true, y_pred, averaging, get_f1_score)
...
def accuracy_score(y_true, y_pred, averaging="micro"):
    return score(y_true, y_pred, averaging, get_accuracy_score)
...
def precision_score(y_true, y_pred, averaging="micro"):
    return score(y_true, y_pred, averaging, get_precision_score)
...
def recall_score(y_true, y_pred, averaging="micro"):
    return score(y_true, y_pred, averaging, get_recall_score)
